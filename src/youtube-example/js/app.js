...
},{"reflux":157}],182:[function(require,module,exports){
		...
		return (
			React.createElement("div", {className: "container"}, 
				React.createElement("div", {className: "tags"}, 
					React.createElement("h3", null, "Filter by clicking on either of the following tags"), 
					React.createElement(Videotags, {tags: this.state.tags}), 
					React.createElement("span", {className: "button", onClick: this._clearFilter}, "Clear Filter")
				), 
				React.createElement("div", {className: "input-wrap"}, 
					React.createElement("h3", null, "Provide a video id and a tag you want to use and watch it update that video."), 
...
},{"../actions/actions.js":181,"../stores/tagsStore.js":189,"../stores/videoStore.js":190,"./tagForm.jsx":184,"./videoList.jsx":186,"./videotags.jsx":187,"react":156,"reflux":157}],183:[function(require,module,exports){
var React = require('react');
var Actions = require('../actions/actions.js');
...
var tag = React.createClass({displayName: "tag",
	render: function() {
		return (
			React.createElement("span", {onClick: this.filterByTag}, this.props.tag)
		)
	},
...
},{"../actions/actions.js":181,"react":156}],184:[function(require,module,exports){
var React = require('react');
...
var tagForm = React.createClass({displayName: "tagForm",
	render: function() {
		return (
			React.createElement("div", {className: "tag-form"}, 
				React.createElement("div", {className: "input-group"}, 
					React.createElement("label", null, "_id: "), 
					React.createElement("input", {ref: "entryInput"})
				), 
				React.createElement("div", {className: "input-group"}, 
					React.createElement("label", null, "Tag: "), 
					React.createElement("input", {ref: "tagInput"})
				), 
				React.createElement("span", {className: "button", onClick: this._addTag}, "Add Tag")
			)
		)
	},
	_addTag: function(){
...
},{"../actions/actions.js":181,"react":156}],185:[function(require,module,exports){
var React = require('react');
...
var video = React.createClass({displayName: "video",
	render: function() {
		var tags = this.props.video.modifiers.tags.terms.map(function(term){
			return React.createElement("span", {onClick: this.filterByTag}, term)
		})
		return (
			React.createElement("div", {className: "video"}, 
				React.createElement("div", {className: "thumbnail"}, 
					React.createElement("img", {src: this.props.video.data.thumbnails.standard.url})
				), 
				React.createElement("div", {className: "videoDetails"}, 
					React.createElement("p", {className: "videoTitle"}, this.props.video.data.title), 
					React.createElement("p", {className: "id"}, "_id: ", this.props.video._id), 
					React.createElement("p", {className: "tags"}, "Tags: ", tags)
				)
			)
		)
	},
...
},{"../actions/actions.js":181,"react":156}],186:[function(require,module,exports){
var React = require('react');
...
var videoList = React.createClass({displayName: "videoList",
	render: function() {
		var videos = this.props.videos.map(function(video){
			return React.createElement(Video, {key: video._id, id: video._id, video: video})
		});
		return (
...
},{"./video.jsx":185,"react":156}],187:[function(require,module,exports){
var React = require('react');

var Tag = require('./tag.jsx');

var videoTags = React.createClass({displayName: "videoTags",
	render: function() {
...
},{"./tag.jsx":183,"react":156}],188:[function(require,module,exports){
var React = require('react');
...
},{"./components/app.jsx":182,"react":156}],189:[function(require,module,exports){
var Reflux = require('reflux');
...
},{"../actions/actions.js":181,"reflux":157,"superagent":178,"superagent-prefix":177}],190:[function(require,module,exports){
var Reflux = require('reflux');
var request = require('superagent');
var delivery = require('superagent-prefix')('http://api.getbraid.io/api/delivery/v1');
...
},{"../actions/actions.js":181,"./tagsStore.js":189,"reflux":157,"superagent":178,"superagent-prefix":177}]},{},[188])